...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of FirebaseObjects
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Sean Clark Hess" => "seanhess@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Sean Clark Hess', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "git@github.com:seanhess/ios-firebase-objects.git", :tag => "0.0.1" }
